...
public class SaCapdfActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_sa_capdf);
        ...
        WebView webView = findViewById(R.id.pdf_webview3);
        ...
        if (pdfUrl != null) {
            ...
            webView.loadUrl("https://drive.google.com/file/d/1SAUZ260800irYbmt3E65Ca0byLGaNRcy/view?usp=drive_link" + pdfUrl);
        }
    }
}